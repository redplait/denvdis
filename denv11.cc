...
// for release 11.0, V11.0.194, md5 f2a560fdf026af752a96b5b0ea401e45
const one_md mds[] = {
 // 52
 { 0x1E72EA0, 0x267E06, 0, 0x6C9E, "sm52_1" },
 { 0x1E6FF00, 0x2F91, 1, 0x6C9E, "sm52_2" },
 // 55
 { 0x74B8A0, 0x26AE4F, 0, 0xC401, "sm55_1" },
 { 0x7488C0, 0x2FC6, 1, 0xC401, "sm55_2" },
 // 57
 { 0x9CA1E0, 0x26F0C2, 0, 0xE44, "sm57_1" },
 { 0x9C71E0, 0x2FE3, 1, 0xE44, "sm57_2" },
 // 70
 { 0x1AE4D80, 0x2A1775, 0, 0xB4A, "sm70_1" },
 { 0x1AE1A80, 0x32E7, 1, 0xB4A, "sm70_2" },
 // 72
 { 0x1315900, 0x2B6620, 0, 0xB4A, "sm72_1" },
 { 0x1312300, 0x35E6, 1, 0xB4A, "sm72_2" },
 /* 75
 { 0xE56BC0, 0x4BB6FB, 0, 0xB4A, "sm75_1" },
 { 0xE51820, 0x539A, 1, 0xB4A, "sm75_2" },
 // 80
 { 0x15D2780, 0x50F2B1, 0, 0x8416, "sm80_1" },
 { 0x15CBF80, 0x67E7, 1, 0x8416, "sm80_2" },
 // 80, 86 - 8416 - ampere
 { 0x19F0E60, 0x556E8D, 0, 0x8416, "sm86_1" },
 { 0x19EA1E0, 0x6C77, 1, 0x8416, "sm86_2" },
 // 89 - 1684 - ada
 { 0x21D2380, 0x5E595C, 0, 0x1684, "sm89_1" },
 { 0x21CB5C0, 0x6DA3, 1, 0x1684, "sm89_2" },
 // 90 - 3927 - h100
 { 0xEBCE80, 0xB2D20B, 0, 0x3927, "sm90_1" },
 { 0xEB4760, 0x8714, 1, 0x3927, "sm90_2" },
